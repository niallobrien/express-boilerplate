...
var config = {
  ...
  wiredep_file: './app/views/layout_source.jade', // looks through given file(s) for bower comments
  wiredep_dest: './app/views/layout.jade' // where to spit out the wiredep'd file(s)
